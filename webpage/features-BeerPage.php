					...
					<div class="content">
						<article class="post_item post_item_single page">
							<div class="post_content">
								...
								<section>
									<div class="content table-responsive table-full-width">
                        				<table class="table table-striped">
                        					<h1 class="sc_title margin_top_tiny-">Beer List</h1>
                        					<?php
								...
								<div class="container">
									<div class="post_content">
										<h1 class="page_title">Select a beer from above table</h1>
										<h3 class="page_subtitle">show bars where this beer sells the most</h3>
											...
											<div class="search_wrap search_style_regular search_state_fixed">
												<div class="search_form_wrap">
													<form action="features-BeerPage.php" method="post"> 
														...
														value="<?php echo $beer;?>" name="inputbeer" />
														<button type="submit" title="Start type" name="select_beer">Submit</button>
													</form>
												</div>
