...
<head>
	...
	<link rel="stylesheet" type="text/css" media="all" href="css/core.portfolio.min.css">
...
<div class="header_mobile">
	...
	<div class="top_panel_title_inner top_panel_inner_style_8 breadcrumbs_present_inner">
		<div class="content_wrap">
			<div class="breadcrumbs"><a class="breadcrumbs_item home" href="#">Home</a><span class="breadcrumbs_delimiter"></span><span class="breadcrumbs_item current">Portfolio (2 columns)</span>
			</div>
		</div>
	</div>
</div>
						...
						<section class="">
							<div class="container">
								<div class="isotope_filters">
									<a href="#" data-filter="*" class="isotope_filters_button active">All</a><a href="#" data-filter=".flt_28" class="isotope_filters_button">whiskey</a><a href="#" data-filter=".flt_21" class="isotope_filters_button">bourbon</a><a href="#" data-filter=".flt_20" class="isotope_filters_button">alcohol</a><a href="#" data-filter=".flt_25" class="isotope_filters_button">irish</a><a href="#" data-filter=".flt_22" class="isotope_filters_button">scotch</a>
								</div>
								<div class="isotope_wrap" data-columns="2">
										...
										<article class="post_item post_item_portfolio post_item_portfolio_2 post_format_standard odd">
											<div class="post_content isotope_item_content ih-item colored square effect_shift left_to_right">
												<div class="post_featured img">
													<a href="#">
														<img alt="The Top 10 Most Expensive Whiskies in the World" src="images/image-1-370x246.jpg">
													</a>
												</div>
												<div class="post_info_wrap info">
													<div class="info-back">
														...
														<div class="post_descr">
															...
															<p>
																<a href="#">Sed ut perspiciatis, unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam eaque ipsa, quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt, explicabo. Nemo enim ipsam voluptatem, quia voluptas sit, aspernatur&#8230;</a>
															</p>
									...
									<div class="isotope_item isotope_item_portfolio isotope_item_portfolio_2 isotope_column_2">
										<article class="post_item post_item_portfolio post_item_portfolio_2 post_format_standard even">
											<div class="post_content isotope_item_content ih-item colored square effect_shift left_to_right">
												<div class="post_featured img">
													<a href="#">
														<img alt="Alcohol to Fight Alcohol: Doctors Use Whisky Therapy" src="images/image-14-370x362.jpg">
													</a>
												</div>
												<div class="post_info_wrap info">
													<div class="info-back">
									...
									<div class="isotope_item isotope_item_portfolio isotope_item_portfolio_2 isotope_column_2">
										<article class="post_item post_item_portfolio post_item_portfolio_2 post_format_standard odd">
											<div class="post_content isotope_item_content ih-item colored square effect_shift left_to_right">
												<div class="post_featured img">
													<a href="#">
														<img alt="Japanese Scotch Whisky Supremacy" src="images/image-3-370x348.jpg">
													</a>
												</div>
												<div class="post_info_wrap info">
													<div class="info-back">
									...
									<div class="isotope_item isotope_item_portfolio isotope_item_portfolio_2 isotope_column_2">
										<article class="post_item post_item_portfolio post_item_portfolio_2 post_format_standard even">
											<div class="post_content isotope_item_content ih-item colored square effect_shift left_to_right">
												<div class="post_featured img">
													<a href="#">
														<img alt="Prices of Quality Whisky Rise to Dizzying Levels" src="images/image-4-370x246.jpg">
													</a>
												</div>
												<div class="post_info_wrap info">
													<div class="info-back">
									...
									<div class="isotope_item isotope_item_portfolio isotope_item_portfolio_2 isotope_column_2">
										<article class="post_item post_item_portfolio post_item_portfolio_2 post_format_standard odd">
											<div class="post_content isotope_item_content ih-item colored square effect_shift left_to_right">
												<div class="post_featured img">
													<a href="#">
														<img alt="Drink &#038; Be Merry, Whisky Helps Check Heart Disease" src="images/image-6-370x415.jpg">
													</a>
												</div>
												<div class="post_info_wrap info">
													<div class="info-back">
									...
									<div class="isotope_item isotope_item_portfolio isotope_item_portfolio_2 isotope_column_2">
										<article class="post_item post_item_portfolio post_item_portfolio_2 post_format_standard even">
											<div class="post_content isotope_item_content ih-item colored square effect_shift left_to_right">
												<div class="post_featured img">
													<a href="#">
														<img alt="Whisky Tastes Best With a Splash of Water" src="images/image-5-370x246.jpg">
													</a>
												</div>
												<div class="post_info_wrap info">
													<div class="info-back">
									...
									<div class="isotope_item isotope_item_portfolio isotope_item_portfolio_2 isotope_column_2">
										<article class="post_item post_item_portfolio post_item_portfolio_2 post_format_standard odd">
											<div class="post_content isotope_item_content ih-item colored square effect_shift left_to_right">
												<div class="post_featured img">
													<a href="#">
														<img alt="Oldest Scotch Sale May Fetch £10,000" src="images/image-12-370x252.jpg">
													</a>
												</div>
												<div class="post_info_wrap info">
													<div class="info-back">
									...
									<div class="isotope_item isotope_item_portfolio isotope_item_portfolio_2 isotope_column_2">
										<article class="post_item post_item_portfolio post_item_portfolio_2 post_format_standard even">
											<div class="post_content isotope_item_content ih-item colored square effect_shift left_to_right">
												<div class="post_featured img">
													<a href="#">
														<img alt="Everything You Need to Know about Moonshine" src="images/image-8-370x246.jpg">
													</a>
												</div>
												<div class="post_info_wrap info">
													<div class="info-back">
									...
									<div class="isotope_item isotope_item_portfolio isotope_item_portfolio_2 isotope_column_2 flt_28">
										<article class="post_item post_item_portfolio post_item_portfolio_2 post_format_standard odd">
											<div class="post_content isotope_item_content ih-item colored square effect_shift left_to_right">
												<div class="post_featured img">
													<a href="#">
														<img alt="A Beginner’s Guide to Making Coctails" src="images/image-9-370x246.jpg">
													</a>
												</div>
												<div class="post_info_wrap info">
													<div class="info-back">
									...
									<div class="isotope_item isotope_item_portfolio isotope_item_portfolio_2 isotope_column_2 flt_21">
										<article class="post_item post_item_portfolio post_item_portfolio_2 post_format_standard even">
											<div class="post_content isotope_item_content ih-item colored square effect_shift left_to_right">
												<div class="post_featured img">
													<a href="#">
														<img alt="The Basics of Mixing a Classic Cocktail" src="images/image-10-370x275.jpg">
													</a>
												</div>
												<div class="post_info_wrap info">
													<div class="info-back">
									...
									<div class="isotope_item isotope_item_portfolio isotope_item_portfolio_2 isotope_column_2 flt_20 flt_21 flt_25 flt_22">
										<article class="post_item post_item_portfolio post_item_portfolio_2 post_format_standard odd">
											<div class="post_content isotope_item_content ih-item colored square effect_shift left_to_right">
												<div class="post_featured img">
													<a href="#">
														<img alt="10 Interesting Facts About Coctails" src="images/image-7-370x263.jpg">
													</a>
												</div>
												<div class="post_info_wrap info">
													<div class="info-back">
														...
														<div class="post_descr">
															...
															<p>
																<a href="#">Officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum&#8230;</a>
															</p>
															<p class="post_buttons"></p>
														</div>
													</div>
